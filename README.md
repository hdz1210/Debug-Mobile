...
[![Release](https://img.shields.io/badge/release-v0.1.8-blue.svg)](https://github.com/hdz1210/Debug-Mobile/releases)
...
| File | Type | Link |
| :--- | :--- | :--- |
| **Setup Installer (Recommended)** | `.exe` | **[Download App-Network-Debugger_0.1.8_windows-x64-setup.exe](https://github.com/hdz1210/Debug-Mobile/releases/download/v0.1.8/App-Network-Debugger_0.1.8_windows-x64-setup.exe)** |
| **Enterprise MSI Package** | `.msi` | [Download App-Network-Debugger_0.1.8_windows-x64.msi](https://github.com/hdz1210/Debug-Mobile/releases/download/v0.1.8/App-Network-Debugger_0.1.8_windows-x64.msi) |
| **Checksum Verification** | `.txt` | [Verify SHA256SUMS.txt](https://github.com/hdz1210/Debug-Mobile/releases/download/v0.1.8/SHA256SUMS.txt) |
| **All Releases** | GitHub | [View GitHub Releases Page](https://github.com/hdz1210/Debug-Mobile/releases/tag/v0.1.8) |
